package com.example.gd12_pdf_b_10915_revisi
...
import com.example.gd12_pdf_b_10915_revisi.R
import com.example.gd12_pdf_b_10915_revisi.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createPdf(nama: String, umur: String, tlp: String, alamat: String, kampus: String) {
        ...
        val file = File(pdfPath,"pdf_10916.pdf")
        ...
        @SuppressLint("UseCompatLoadingForDrawables") val d = getDrawable(R.drawable.ayaka_bestgirl)
        ...
        val group = Paragraph(
            """ 
                Berikut adalah Nama Pengguna UAJY 20022/2023
        ...
        val barcodeQRCode = BarcodeQRCode(
            """
                                ...
                                $(LocalTime.now().format(timeFormater)}
                                """.trimIndent()
        )
